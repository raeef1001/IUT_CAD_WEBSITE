...
export interface ApiAchievementAchievement extends Schema.CollectionType {
  ...
  attributes: {
    ...
    name_of_writer: Attribute.String;
    description: Attribute.RichText;
    image: Attribute.Media;
    is_featured: Attribute.Boolean;
    type: Attribute.Text & Attribute.DefaultTo<'achievements'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiActivityActivity extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media;
    is_featured: Attribute.Boolean;
    type: Attribute.Text & Attribute.DefaultTo<'activities'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    name_of_writer: Attribute.String;
    is_featured: Attribute.Boolean;
    type: Attribute.Text & Attribute.DefaultTo<'blogs'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiInterUniversityRegistrationInterUniversityRegistration
  extends Schema.CollectionType {
  collectionName: 'inter_university_registrations';
  info: {
    singularName: 'inter-university-registration';
    pluralName: 'inter-university-registrations';
    displayName: ' Inter-University-Registration';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    competitionDate: Attribute.Date;
    registrationDeadline: Attribute.Date;
    description: Attribute.RichText;
    category: Attribute.Enumeration<
      ['CTF', 'Competitive Programming', 'Hackathon', 'Quiz']
    >;
    TeamLeadName: Attribute.String;
    ContactEmail: Attribute.String;
    ContactPhone: Attribute.BigInteger;
    competition_name: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::inter-university-registration.inter-university-registration',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiIntraUniversityRegistrationIntraUniversityRegistration
  extends Schema.CollectionType {
  collectionName: 'intra_university_registrations';
  info: {
    singularName: 'intra-university-registration';
    pluralName: 'intra-university-registrations';
    displayName: ' Intra-University-registration';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    competitionName: Attribute.String;
    date: Attribute.Date;
    googleFormLink: Attribute.Text;
    description: Attribute.RichText;
    registrationDeadline: Attribute.Date;
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::intra-university-registration.intra-university-registration',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiRegistrationRegistration extends Schema.CollectionType {
  ...
  attributes: {
    ...
    team_size: Attribute.String;
    team_lead_name: Attribute.String;
